-- -----
-- copy and change from https://github.com/ashfinal/awesome-hammerspoon/blob/master/init.lua
-- ----
...
------------------------
-- you can not delete or change it 
-- ---------
function obj.rebind()
    appRegister()
    registerAltA()
